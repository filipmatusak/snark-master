...
case class TestComponent(component: Component, configuration: Configuration, tests: Seq[StartComponentTestMessage]) extends ControlPanelMessage
...
case class ParsedComponent(graphs: Component, file: File) extends Message
